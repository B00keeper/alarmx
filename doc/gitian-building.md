...
in the Alarmx Core repository under 'Fetch and create inputs' to install sources which require
...
BTCPATH=/some/root/path/alarmx
SIGPATH=/some/root/path/alarmx-detached-sigs
